...
const RecruiterLogin = () => {
    ...
    // if user click on Recruiter Login  page will not scroll
    useEffect(()=>{
    ...
    return (
        <div className='absolute top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center'>
            <form onSubmit={onSubmitHandler} className='relative bg-white p-10 rounded-xl text-slate-500'>
                ...
                {/* if thet state is signup and isTextDataSubmited is true it will display these part  */}
                {state === "Sign Up" && isTextDataSubmited
                    ...
                    {/* if thet state is signup and isTextDataSubmited is false it will display these part  */}
                        {state !== 'Login' && (
