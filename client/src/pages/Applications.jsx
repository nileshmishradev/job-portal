...
const Applications = () => {
  ...
  const [isEdit, setIsEdit] = useState(false) // to display edit section
    ...
    <>
      ...
      <div className='container px-4 min-h-[65vh] 2xl:px-20 mx-auto my-10'>
        ...
        <div className='flex gap-2 mb-6 mt-3'>
          {
            isEdit  // id isEdit is truec than display label section
              ? <>
                {/* htmlFor is used to connect label in these we connecting with input */}
        ...
        {/* displaying job that applied in table form */}
